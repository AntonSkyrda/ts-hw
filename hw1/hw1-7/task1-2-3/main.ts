...
let sortedUsers: CreateUser[] = createdUsers.sort((a: CreateUser, b: CreateUser) => a.id - b.id);
let filteredUsers: CreateUser[] = createdUsers.filter((user: CreateUser) => user.id % 2 === 0);
